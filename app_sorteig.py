...
def assignar_isards_sorteig_csv(
    ...
    # Calcular nova prioritat i història
...
if file:
    ...
    if especie == 'Isard' and unidad == 'TCC':
        result = assignar_isards_sorteig_csv(df, total_cap)
    else:
